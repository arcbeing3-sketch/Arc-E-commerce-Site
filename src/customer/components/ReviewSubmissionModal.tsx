      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          <div className="p-6 border-b border-zinc-100 flex items-center justify-between bg-zinc-50">
            <div>
              <span className="text-[11px] font-bold tracking-wider uppercase text-zinc-400">Write a Review</span>
              <h3 className="text-base font-bold text-zinc-900 truncate max-w-xs">{product.name}</h3>
            </div>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            {/* Rating Stars */}
            <div>
              <label className="block text-xs font-semibold text-zinc-700 mb-1.5">Rating</label>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm border border-zinc-300 rounded-xl focus:ring-2 focus:ring-zinc-900 focus:outline-none"
              />
            </div>

            <div>
              <label className="block text-xs font-semibold text-zinc-700 mb-1">Headline / Review Summary</label>
              <input
                type="text"
                value={title}
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-700 mb-1">Detailed Review</label>
              <textarea
                required
                rows={4}
                value={comment}
            ...
            <div className="pt-2 flex items-center justify-end gap-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-5 py-2.5 bg-zinc-900 hover:bg-black text-white text-xs font-bold rounded-xl transition-all shadow disabled:opacity-50 flex items-center gap-1.5"
              >
