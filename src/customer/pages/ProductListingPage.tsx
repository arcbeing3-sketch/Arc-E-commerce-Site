  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="border-b border-zinc-200 pb-6">
        <span className="text-xs font-bold tracking-widest uppercase text-zinc-400">ARC Hardware Studio</span>
        <h1 className="text-3xl font-extrabold text-zinc-900 mt-1">Hardware Catalog</h1>
      ...
      <div className="flex flex-col lg:flex-row gap-4 justify-between items-stretch lg:items-center bg-zinc-50 p-4 rounded-2xl border border-zinc-200/80">
        {/* Category Pills */}
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative flex-1 sm:w-60">
            ...
            <input
              ...
              className="w-full pl-9 pr-8 py-2 text-xs bg-white border border-zinc-300 rounded-xl focus:ring-2 focus:ring-zinc-900 focus:outline-none"
            />
            {searchQuery && (
              <button
          ...
          {/* In-Stock Toggle */}
          <label className="flex items-center gap-2 cursor-pointer bg-white px-3 py-2 border border-zinc-200 rounded-xl text-xs font-medium text-zinc-700 select-none hover:bg-zinc-50">
            <input
              type="checkbox"
              checked={inStockOnly}
          ...
          <div className="relative">
            <select
              ...
              className="text-xs font-semibold text-zinc-700 bg-white border border-zinc-200 rounded-xl px-3 py-2 appearance-none pr-8 cursor-pointer focus:outline-none focus:ring-2 focus:ring-zinc-900"
            >
